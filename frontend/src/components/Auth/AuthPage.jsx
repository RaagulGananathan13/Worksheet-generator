...
import { Mail, Lock, Eye, EyeOff, LogIn, UserPlus, AlertCircle, ArrowRight, Loader2 } from 'lucide-react';
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      if (!EMAIL_REGEX.test(email.trim().toLowerCase())) {
        setLocalError(
          'Email must match geniusbees.devXX@gmail.com (e.g., geniusbees.dev01@gmail.com)'
        );
        return;
      }
    ...
    [email, password, confirmPassword, mode, login, signup, clearError]
  );
            ...
            <div>
              ...
              {mode === 'signup' && (
                <p className="mt-1 text-[10px] text-surface-400">
                  Only geniusbees.devXX@gmail.com emails are accepted
                </p>
              )}
            </div>
